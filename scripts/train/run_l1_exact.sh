...
python3 main_ppo.py \
    ...
    data.train_files=/disk3/yiran/yaoqi/l1/data_exact/train.parquet \
    data.val_files=/disk3/yiran/yaoqi/l1/data_exact/aime.parquet \
    ...
    trainer.experiment_name='qwen2.5-1.5B-Instruct-l1_exact' \
